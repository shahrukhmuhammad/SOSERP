                            ...
                            if (n.changeInput) {
                                switch (typeof n.changeInput) {
                                    case "boolean":
                                        ...
                                        o = $('<div class="diskuf-uploader"><span class="wd-fa-add-file-light"><span class="wd-fa-add-file-light-text"><span class="wd-fa-add-file-light-title"><span class="wd-fa-add-file-light-title-text">Upload files and images</span></span><span class="wd-fa-add-file-light-descript">Drag files here to upload</span></span></span></div>');
                                        break;
                                    case "string":
                                    case "object":
                                        o = $(n.changeInput);
