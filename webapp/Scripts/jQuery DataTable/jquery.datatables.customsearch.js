    ...
    var factory = function ($, DataTable) {
        ...
        CustomSearch.prototype = {
            ...
            init: function (dt, config) {
                ...
                //changed from .change
                $('#' + allIds.join(',#')).bind("keyup change", function (e) {
                    if (e.keyCode == 13) {
                        return false;
                    }
            ...
            createField: function (field) {
                ...
                switch (field.type) {
                    case 'string':
                        ...
                        field.field = field.advanced.field + '<input class="form-control input-sm" type="text" placeholder="' + field.label.toLowerCase() + '" id="' + field.id + '">';
                        break;
                    case 'number':
                        if (field.range.length === 0) {
                            if (field.label) {
                            ...
                            field.field = field.advanced.field + '<input  class="form-control input-sm" type="number" placeholder="' + field.label.toLowerCase() + '" id="' + field.id + '">';
                        } else {
                            if (this.hasRange('min', field.range)) {
                                if (field.label) {
                                    field.fieldLabel.push('<label for="' + field.id.min + '">' + field.label.min + '</label>');
                                }
                                field.field.push('<input  class="form-control input-sm" type="number" placeholder="' + field.label.toLowerCase() + '" id="' + field.id.min + '">');
                            }
                            ...
                            if (this.hasRange('max', field.range)) {
                                ...
                                field.field.push('<input  class="form-control input-sm" type="number" placeholder="' + field.label.toLowerCase() + '" id="' + field.id.max + '">');
                            }
                        }
                        break;
                    case 'select':
                        ...
                        field.field = field.advanced.field + '<select  class="form-control input-sm" placeholder="' + field.label.toLowerCase() + '" id="' + field.id + '"';
                    ...
                    case 'date':
                        if (field.range.length === 0) {
                            ...
                            field.field = field.advanced.field + '<input  class="form-control input-sm" type="date" placeholder="' + field.label.toLowerCase() + '" id="' + field.id + '">';
                        } else {
                            if (this.hasRange('min', field.range)) {
                                if (field.label) {
                                    field.fieldLabel.push('<label for="' + field.id.min + '">' + field.label.min + '</label>');
                                }
                                field.field.push('<input  class="form-control input-sm" type="date" placeholder="' + field.label.toLowerCase() + '" id="' + field.id.min + '">');
                            }
                            ...
                            if (this.hasRange('max', field.range)) {
                                ...
                                field.field.push('<input  class="form-control input-sm" type="date" placeholder="' + field.label.toLowerCase() + '" id="' + field.id.max + '">');
                            }
                        }
                        break;
            ...
            getAdvanced: function (advanced, range, id, type) {
                ...
                if (advanced === true && range.length === 0) {
                    advancedField += '<select  class="form-control input-sm" placeholder="' + field.label.toLowerCase() + '" id="' + advancedId + '">';
