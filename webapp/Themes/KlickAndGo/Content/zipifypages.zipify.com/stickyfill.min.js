!(function(a, b) {
    ...
    function p(a, b) {
        ...
        switch (b) {
            case 0:
                (c.position = 'absolute'), (c.left = a.offset.left + 'px'), (c.right = a.offset.right + 'px'), (c.top =
                    a.offset.top + 'px'), (c.bottom = 'auto'), (c.width =
                    'auto'), (c.marginLeft = 0), (c.marginRight = 0), (c.marginTop = 0);
                break;
            case 1:
                (c.position = 'fixed'), (c.left = a.box.left + 'px'), (c.right = a.box.right + 'px'), (c.top =
                    a.css.top), (c.bottom = 'auto'), (c.width =
                    'auto'), (c.marginLeft = 0), (c.marginRight = 0), (c.marginTop = 0);
                break;
            case 2:
                (c.position = 'absolute'), (c.left = a.offset.left + 'px'), (c.right = a.offset.right + 'px'), (c.top =
                    'auto'), (c.bottom = 0), (c.width = 'auto'), (c.marginLeft = 0), (c.marginRight = 0);
        }
        a.mode = b;
    }
    function q(a) {
        ...
        (c.height = a.height + 'px'), (c.width = a.width + 'px'), (c.marginTop =
            a.computed.marginTop), (c.marginBottom = a.computed.marginBottom), (c.marginLeft =
            a.computed.marginLeft), (c.marginRight =
            a.computed.marginRight), (c.padding = c.border = c.borderSpacing = 0), (c.fontSize = '1em'), (c.position =
            'static'), (c.cssFloat = a.computed.cssFloat), a.node.parentNode.insertBefore(a.clone, b);
    }
    function r(a) {
    ...
    function A() {
        b.removeEventListener('scroll', g), b.removeEventListener('wheel', h), b.removeEventListener(
            'resize',
            z
        ), b.removeEventListener('orientationchange', z), a.removeEventListener(M, x), w(), (I = !1);
    }
    function B() {
        A(), o();
    }
